...
(though if you use an expression such as link:file-language.adoc[File Language], or link:simple-language.adoc[Simple] then the result of the expression
...
then that's using the link:file-language.adoc[File Language] which we
...
the link:file-language.adoc[File Language] to do advanced configuration
of the directory and name pattern. +
 Camel will, in fact, internally convert the directory name you enter
into a link:file-language.adoc[File Language] expression. So when we
...
See more examples at link:file-language.adoc[File Language]
...
link:file-language.adoc[File Language] or link:simple-language.adoc[Simple]
...
string-based link:file-language.adoc[File Language] expression in the
`CamelFileName` header. See the link:file-language.adoc[File Language]
...
See link:file-language.adoc[File Language] for more samples.
...
Camel supports pluggable sorting strategies. This strategy it to use the
link:file-language.adoc[File Language] to configure the sorting. The
...
As we have the full power of link:file-language.adoc[File Language] we
...
want to sort by date only and then subgroup by name? +
 Well as we have the true power of link:file-language.adoc[File Language] we can use its date command that supports patterns. So this
can be solved as:
