...
For example when using link:../../../../components/camel-jms/src/main/docs/jms-component.adoc[JMS] with InOut the component will
...
When consuming messages from link:../../../../components/camel-jms/src/main/docs/jms-component.adoc[JMS] a Request-Reply is
