...
in the same way as the link:bean-component.adoc[Bean] component but instead of
...
You simply use the *class* component just as the link:bean-component.adoc[Bean] component but by specifying the fully qualified classname instead. +
...
TIP: See more details at the link:bean-component.adoc[Bean] component as the *class*
component works in much the same way.

=== See Also

* Configuring Camel
* link:../../../readme.adoc[Core Component]
* link:../../../../components/readme.adoc[Component]
* Endpoint
* Getting Started

* link:bean-component.adoc[Bean] component
* link:binding-component.adoc[Binding] Component (_deprecated_)
* Bean Integration
