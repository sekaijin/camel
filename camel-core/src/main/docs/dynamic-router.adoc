...
Which will leverage a * link:bean-component.adoc[Bean] to compute the slip
...
Mind that in Camel 2.9.2 or older, when using a * link:bean-component.adoc[Bean] the
