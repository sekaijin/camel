...
Camel also supports invoking link:bean-component.adoc[Bean] as an Endpoint. In the
route below:
...
Java DSL comes with syntactic sugar for the link:bean-component.adoc[Bean]
...
* link:class-component.adoc[Class] component
