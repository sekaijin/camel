...
TIP: *Asynchronous*
The link:seda-component.adoc[SEDA] component provides asynchronous invocation of
any consumers when a producer sends a message exchange.

TIP: *Connection to other camel contexts*
The link:vm-component.adoc[VM] component provides connections between Camel
...
See also samples from the link:seda-component.adoc[SEDA] component, how they can
be used together.
