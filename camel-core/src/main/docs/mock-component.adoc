...
notoriously difficult. The link:mock-component.adoc[Mock], link:test-component.adoc[Test]
and link:dataset-component.adoc[DataSet] endpoints work great with the
Camel Testing Framework to simplify your unit and
integration testing using
link:../../../readme-eip.adoc[Enterprise Integration
...
link:xpath-language.adoc[XPath] or link:xpath-language.adoc[XQuery]
Expression.

[NOTE]
There is also the link:test-component.adoc[Test endpoint] which is a
...
or link:../../../../components/camel-jpa/src/main/docs/jpa-component.adoc[database], for example.
...
link:../../test/java/org/apache/camel/processor/[`camel-core`
processor tests].
...
is that a link:mock-component.adoc[Mock] endpoint is injected and receives the
...
To only mock all link:log-component.adoc[Log] endpoints you can define the pattern
...
The link:mock-component.adoc[Mock] endpoints will by default keep a copy of every
...
The link:mock-component.adoc[Mock] endpoint stores the arrival time of the message
...
set expectations using the `arrives` DSL on the link:mock-component.adoc[Mock]
endpoint.
