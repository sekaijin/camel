...
From Camel 2.2 onwards, the file language is now merged with link:simple-language.adoc[Simple] language which means you can use all the file
syntax directly within the simple language.

The File Expression Language is an extension to the link:simple-language.adoc[Simple] language, adding file related capabilities.
...
File and link:../../../../components/camel-ftp/src/main/docs/ftp-component.adoc[FTP] components for setting
...
This language is an *extension* to the link:simple-language.adoc[Simple] language
so the link:simple-language.adoc[Simple] syntax applies also. So the table below
only lists the additional.  +
 As opposed to link:simple-language.adoc[Simple] language
link:simple-language.adoc[Simple] also supports
link:constant-language.adoc[Constant] expressions so you can enter a fixed
filename.
...
supported by the current Exchange. For instance the link:../../../../components/camel-ftp/src/main/docs/ftp-component.adoc[FTP]
...
an *extension* to the link:simple-language.adoc[Simple] language. Additional
command is: *file* (consumers only) for the last modified timestamp of
the file. Notice: all the commands from the link:simple-language.adoc[Simple]
...
You can enter a fixed link:constant-language.adoc[Constant] expression such as
`myfile.txt`:
...
As this is an extension to the link:simple-language.adoc[Simple] language we have
...
use the link:simple-language.adoc[Simple], link:file-language.adoc[File] Language
and the link:bean-component.adoc[Bean] language in one combined expression. This
...
In Camel you can use the link:file-language.adoc[File] Langage directly
from the link:simple-language.adoc[Simple] language which makes a
...
to set a dynamic filename using the link:simple-language.adoc[Simple] Language then make sure you  +
