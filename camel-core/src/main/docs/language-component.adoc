...
Routing Slip or link:dynamic-router.adoc[Dynamic
...
link:../../../../components/camel-groovy/src/main/docs/groovy-language.adoc[Groovy] or link:javascript-language.adoc[JavaScript] languages.
...
link:language-component.adoc[Language]s in Camel
...
For example you can use the link:simple-language.adoc[Simple] language to
Message Translator a message:

In case you want to convert the message body type you can do this as
well:

You can also use the link:../../../../components/camel-groovy/src/main/docs/groovy-language.adoc[Groovy] language, such as this
...
link:xpath-language.adoc[XPath] language to extract the text from the `<foo>`
tag.
...
other link:language-component.adoc[Language]s in Camel by prefixing with
