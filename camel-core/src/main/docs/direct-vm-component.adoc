...
This component differs from the link:direct-component.adoc[Direct] component in
that link:direct-vm-component.adoc[Direct-VM] supports communication across
