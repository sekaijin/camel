...
notoriously difficult. The link:mock-component.adoc[Mock], link:mock-component.adoc[Test]
...
Camel will use the link:log-component.adoc[throughput logger] when sending
dataset's.
