...
The *dataformat:* component allows to use link:data-format.adoc[Data
...
For example to use the link:../../../../components/camel-jaxb/src/main/docs/jaxb-dataformat.adoc[JAXB] link:data-format.adoc[Data
