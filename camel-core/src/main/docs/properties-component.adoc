...
link:properties-component.adoc[Properties] component
...
Then you could setup the link:properties-component.adoc[Properties] component as
follows:
...
=== Example with link:simple-language.adoc[Simple] language

The link:simple-language.adoc[Simple] language now also support using property
...
You can also specify the location in the link:simple-language.adoc[Simple]
...
syntax clashes with the link:simple-language.adoc[Simple] in Camel, and therefore
...
to indicate using the link:simple-language.adoc[Simple] language in Camel.
...
link:properties-component.adoc[Properties] component, you may want to be able to
...
The link:properties-component.adocProperties] component includes the following
...
the link:../../../../components/camel-http/src/main/docs/http-component.adoc[HTTP] component to make the HTTP call:
...
The link:properties-component.adoc[Properties] component allow to plugin 3rd party
