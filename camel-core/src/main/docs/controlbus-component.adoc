...
link:controlbus-component.adoc[Control Bus] Component that allows you to
...
applications based on the link:controlbus-component.adoc[Control Bus] EIP
pattern. 
...
|`language` |Allows you to specify a link:language-component.adoc[Language] to use for
...
You can use the lin:simple-language[Simple] language with the control bus,
...
that has stronger powers such as link:../../../../components/camel-groovy/src/main/docs/groovy-language.adoc[Groovy] or to some
extend the link:simple-language.adoc[Simple] language.
...
TIP: You can also use other languages such as link:../../../../components/camel-groovy/src/main/docs/groovy-language.adoc[Groovy], etc.
